/*! This file is auto-generated */ ! function() {
    ...
    const s = /<!--\s+(\/)?wp:([a-z][a-z0-9_-]*\/)?([a-z][a-z0-9_-]*)\s+({(?:(?=([^}]+|}+(?=})|(?!}\s+\/?-->)[^])*)\5|[^]*?)}\s+)?(\/)?-->/g;
    ...
    function f() {
        ...
        switch (t) {
            case "no-more-tokens":
                ...
                return !1;
            case "void-block":
                return 0 === d ? (null !== g && o.push(c(e.substr(g, k - g))), o.push(l(i, f, [], "", [])), r = k + h, !0) : (a(l(i, f, [], "", []), k, h), r = k + h, !0);
            case "block-opener":
                ...
                }(l(i, f, [], "", []), k, h, k + h, g)), r = k + h, !0;
            case "block-closer":
                if (0 === d) return p(), !1;
                if (1 === d) return b(k), r = k + h, !0;
                const n = u.pop(),
                    t = e.substr(n.prevOffset, k - n.prevOffset);
                return n.block.innerHTML += t, n.block.innerContent.push(t), n.prevOffset = k + h, a(n.block, n.tokenStart, n.tokenLength, k + h), r = k + h, !0;
            default:
                return p(), !1
        }
    }
    ...
    function b(n) {
        const {
            ...
            prevOffset: s,
            tokenStart: l
        } = u.pop(), i = n ? e.substr(s, n - s) : e.substr(s);
