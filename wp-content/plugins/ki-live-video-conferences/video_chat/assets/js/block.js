...
(function(window, document, wp) {
    ...
    const PostsDropdownControl = wp.compose.compose(
        ...
        if (props.posts) {
            options.push({
                value: 0,
                label: __('Select meeting', 'ki-live-video-conferences')
            });
            ...
            options.push({
                value: 0,
                label: __('Loading...', 'ki-live-video-conferences')
            })
        }
    ...
    wp.blocks.registerBlockType('ki-live-video-conferences/block', {
        ...
        edit: function(props) {
            ...
            props.setAttributes({
                type: ki_live_video_conferences_block.post_type
            });
            props.setAttributes({
                latest: props.attributes.latest
            });
